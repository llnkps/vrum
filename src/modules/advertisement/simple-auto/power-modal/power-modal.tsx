  ...
  return (
    ...
    >
      <BottomSheetView className="flex-row items-center justify-center gap-x-10 border-1 border-border-focused">
        <View className="mr-3">
          <Text className="text-lg font-bold text-font dark:text-font-dark">Мощность (л.с.) =</Text>
        </View>
        <CustomWheelPicker data={powerArray} value={fromYear} onValueChanged={handleChange} />
      </BottomSheetView>
    </CustomBottomSheetModal>
  );
});
