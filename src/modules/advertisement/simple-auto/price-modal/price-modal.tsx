    ...
    >
      <View className="pt-5 flex-row items-center justify-center gap-x-10 px-4">
        <View className="flex-1">
          <Text className="font-bold text-lg text-font dark:text-font-dark">
            От
          </Text>
          <BottomSheetTextInput
            className="p-3 bg-background-input dark:bg-background-input-dark rounded-md text-font dark:text-font-dark"
