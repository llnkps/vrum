    ...
    >
      <BottomSheetView>
        <View className="flex-row items-center justify-center gap-x-10">
          <View className="mr-3">
            <Text className="text-lg font-bold text-font dark:text-font-dark">Год</Text>
          </View>
          <CustomWheelPicker data={years} value={releaseYear} onValueChanged={handleReleaseYear} />
        </View>
      </BottomSheetView>
    </CustomBottomSheetModal>
  );
