...
const SearchSection = () => {
  ...
  return (
    <View className={'bg-background dark:bg-background-dark gap-y-1 px-4 py-3'}>
      ...
      >
        <Text className="font-bold text-font dark:text-font-dark">Раздел, класс</Text>
      </Pressable>
      ...
      >
        <Text className="font-bold text-font dark:text-font-dark">Марка, модель, модификация</Text>
      </Pressable>
