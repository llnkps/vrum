		...
		if (loading) {
			return (
				<View className='flex-1 items-center justify-center'>
					...
					<Text className='text-font dark:text-font-dark mt-4'>
						Загрузка...
					</Text>
				</View>
			);
		...
		<SafeAreaProvider>
			<SafeAreaView className='flex-1 bg-background-page dark:bg-background-page-dark'>
				<View className='flex-1'>
					...
					{/* Tabs */}
					<View className='flex-row justify-center bg-background-neutral rounded-lg mx-4 mb-2 p-1 dark:bg-background-neutral-dark'>
