    ...
    <SafeAreaProvider>
      <SafeAreaView className="flex-1">
        <View className="flex-row justify-center border-b border-border dark:border-border-dark">
          ...
          >
            <Text className={`text-center font-medium ${tab === "messages"
          ...
          >
            <Text className={`text-center font-medium ${tab === "events"
              ? "text-font-selected dark:text-font-selected-dark"
              : "text-font-subtle dark:text-font-subtle-dark"}`}>События</Text>
          </TouchableOpacity>
        </View>
        ...
        <ScrollView className="flex-1" contentContainerStyle={{
          ...
          {tab === "messages" ? (
            ...
            <>
              <Ionicons name="newspaper-outline" size={64} color={iconColor} className="mb-4"/>
              <Text className="text-font dark:text-font-subtle-dark text-center mx-10">
