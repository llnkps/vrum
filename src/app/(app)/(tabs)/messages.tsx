      ...
      <SafeAreaView className="flex-1">
        <View className="flex-row justify-center border-b border-border dark:border-border-dark">
          <TouchableOpacity
            ...
            ${tab === 'messages' ? 'border-b-2 border-border-selected dark:border-border-selected-dark' : ''}`}
            onPress={() => setTab('messages')}
          >
            <Text
              className={`text-center font-medium ${
                tab === 'messages' ? 'text-font-selected dark:text-font-selected-dark' : 'text-font-subtle dark:text-font-subtle-dark'
              }`}
            >
              Сообщения
            </Text>
          ...
          <TouchableOpacity
            className={`flex-1 py-2 
            ${tab === 'events' ? 'border-b-2 border-border-selected dark:border-border-selected-dark' : ''}`}
            onPress={() => setTab('events')}
          >
            <Text
              className={`text-center font-medium ${
                tab === 'events' ? 'text-font-selected dark:text-font-selected-dark' : 'text-font-subtle dark:text-font-subtle-dark'
              }`}
            >
              События
            </Text>
