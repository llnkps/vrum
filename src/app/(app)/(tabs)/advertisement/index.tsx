...
export default function MyAdvertisement() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background-page dark:bg-background-page-dark">
      ...
      {/* Bottom bar */}
      <View className="absolute bottom-0 left-0 right-0 bg-surface dark:bg-surface-dark rounded-t-3xl px-4 pt-6 pb-10 shadow-lg border-t border-border dark:border-border-dark">
