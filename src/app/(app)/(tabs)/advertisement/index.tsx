...
export default function MyAdvertisement() {
  ...
  return (
    <SafeAreaView className="flex-1">
      ...
      {/* Bottom bar */}
      <View
        className="absolute bottom-0 left-0 right-0 rounded-t-3xl border-t border-border bg-surface px-4 pb-10 pt-6 shadow-lg dark:border-border-dark dark:bg-surface-dark"
