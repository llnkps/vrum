...
import { DefaultConfig, GetAppSimpleautocontextPresentationBrandgetcollectionGetbrands200ResponseInner } from "@/openapi/client";
...
const ModelItemScreenFilterModalBlock: FC<props> = ({ brands, scrollY, isScrolling }) => {
  ...
  const { addSelectedBrand } = useAutoSelectStore();
  ...
  const handleAddBrand = (brand: GetAppSimpleautocontextPresentationBrandgetcollectionGetbrands200ResponseInner) => {
    addSelectedBrand(brand);
    router.push("/search-screen/simple-auto-screen/modals/brand-auto-modal-type-filter");
  };
