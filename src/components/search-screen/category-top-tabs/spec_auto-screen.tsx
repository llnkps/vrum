...
const SearchSection = () => {
  ...
  return (
    <View className={"px-4 py-3 gap-y-1 bg-background dark:bg-background-dark"}>
      ...
      >
        <Text className="text-font dark:text-font-dark font-bold">Раздел, тип техники</Text>
      </Pressable>
      ...
      >
        <Text className="text-font dark:text-font-dark font-bold">Марка, модель</Text>
      </Pressable>
