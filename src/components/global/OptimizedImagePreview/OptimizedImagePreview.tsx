...
export const OptimizedImagePreview = memo<OptimizedImagePreviewProps>(
  ({ uri, width = 96, height = 96, onDelete, showDeleteButton = true, isPrimary = false, style }) => {
    ...
    if (error) {
      return (
        <View style={[{ width, height, backgroundColor: '#f3f4f6', borderRadius: 8, justifyContent: 'center', alignItems: 'center' }, style]}>
      ...
      <View style={[{ position: 'relative' }, style]}>
        ...
        >
          {loading ? (
            ...
            <Image source={{ uri: optimizedUri || uri }} style={{ width, height, borderRadius: 8 }} resizeMode="cover" />
          )}
        </View>
